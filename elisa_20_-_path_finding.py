...
from elisa.sprite import Tile, TileMap, SpriteSheet, Sprite, SpriteAnimation, tilemap_from_tiled, spritesheet_from_tiled
...
def main():
	...
	tm_renderer = TileMapRenderer(world, tileatlas, world_x=MAP_OFFSET_X, world_y=MAP_OFFSET_Y, view_width=S_WIDTH, view_height=S_HEIGHT)
