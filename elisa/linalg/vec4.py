...
class Vec4:
    ...
    def __repr__(self):
        return "Vec4[{}, {}, {}, {}]".format(
            self._v[0], self._v[1], self._v[2], self._v[3]
        )

    @staticmethod
    def is_zero(v):
        return v[0] == 0.0 and v[1] == 0.0 and v[2] == 0.0 and v[3] == 0.0
    ...
    def unit_vector(u: Vec4) -> Vec4:
        """Computes the unit vector of u

        Args:
            u (Vec4): vector for which we desire to compute the unit vector

        Returns:
            Vec4: the unit vector of u.
        """
