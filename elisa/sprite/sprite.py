...
class Sprite(object):
	def __init__(self, name:str, w: int, h: int, img, img_fp:str, z:int = 0, color_key=None):
		"""
	...
	@staticmethod
	def from_image(image_fp, name:str = None, color_key: tuple = None, verbose: bool = False):
		...
		return Sprite(name, w=rect[2], h=rect[3], img=p_image, img_fp=image_fp, color_key=color_key)
	...
	def __repr__(self):
		return "{} (w, h, z, vis, ckey => {}, {}, {}, {}, {})".format(self._id, 
		self._width, 
		self._height, 
		self._z_order, 
